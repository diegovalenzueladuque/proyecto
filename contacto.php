					...
					<form >
						<div class="form-group">
						    ...
						    <input type="email" class="form-control" id="name" 
						           aria-describedby="emailHelp" placeholder="Ingrese su nombre y apellido"style="width: 50%"><br>
						    <label for="phone">Teléfono</label>
						    <input type="email" class="form-control" id="phone" 
						           aria-describedby="emailHelp" placeholder="Ingrese su teléfono"style="width: 50%"><br>
						    <label for="exampleInputEmail1">Email</label>
						    <input type="email" class="form-control" id="email" 
						           aria-describedby="emailHelp" placeholder="Ingrese correo Electrónico"style="width: 50%"><br>
						           <label for="exampleInputEmail1">Asunto</label>
						    <textarea type="email" class="form-control" id="email" 
						           aria-describedby="emailHelp" placeholder="Indica asunto del correo"style="width: 50%"></textarea><br>
